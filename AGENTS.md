...
2. Yêu cầu trực tiếp mới nhất của Sếp.
3. `AGENTS.md` ở workspace này.
4. Các file tham chiếu: `SOUL.md`, `IDENTITY.md`, `USER.md`, `BOOTSTRAP.md`, `TOOLS.md`.
5. Memory files nếu tồn tại.
